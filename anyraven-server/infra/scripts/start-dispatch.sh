...
TOKEN_FILE="$DATA_ROOT/.anyraven/pb-token"
ADMIN_FILE="$DATA_ROOT/.anyraven/pb-admin"
ADMIN_EMAIL="${ANYRAVEN_PB_ADMIN_EMAIL:-admin@anyraven.local}"
...
exec /usr/local/bin/node /anyraven/dispatch/dist/index.js
