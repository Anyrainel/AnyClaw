...
- Mount the MCP server (`@anyraven/mcp-server`) at `/mcp`.
...
| `ANYRAVEN_DATA_ROOT` | `/data` | Override data directory (tests) |
...
- `@anyraven/mcp-server` — MCP tools, mounted at `/mcp`
- `@anyraven/shared` — paths, deploy/rollback managers, worktrees
