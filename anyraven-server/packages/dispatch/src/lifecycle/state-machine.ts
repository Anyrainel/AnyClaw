...
const TABLE: Record<TaskState, Partial<Record<TaskEvent, TaskState>>> = {
  ...
  working:     { ask_user: "clarifying", deploy_called: "deploying", progress: "working", cancel: "cancelled", validation_fail: "failed", validation_pass: "done" },
  clarifying:  { answer: "working", cancel: "cancelled", validation_fail: "failed" },
