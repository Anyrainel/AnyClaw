...
SERVER_DIR="$ROOT_DIR/anyclaw-server"
...
npm run build --workspace @anyclaw/frontend-template --prefix "$SERVER_DIR"
...
docker exec "$CONTAINER_NAME" sh -lc "FRONTEND_TEMPLATE_SRC='$DEV_TEMPLATE_TMP' /anyclaw/scripts/sync-frontend-template.sh --force"
